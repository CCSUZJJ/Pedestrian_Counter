...
#ifndef TINYXMLCPP_INCLUDED
#define TINYXMLCPP_INCLUDED
...
#define DEBUG
    ...
    #ifndef TIXML_CPP_USE_STL
        #define TIXML_CPP_USE_STL
	#endif
#endif

#ifdef TIXML_CPP_USE_STL
    #include <string>
    #include <iostream>
    #include <sstream>
    #define TIXML_CPP_STRING		std::string
#else
    #include "tinystr++.h"
    #define TIXML_CPP_STRING		TiXmlString
#endif
...
class TICPP_API TiXmlBase : public ticpp::TiCppRC
#else
...
public:
	...
	*/
    static void EncodeString( const TIXML_CPP_STRING& str, TIXML_CPP_STRING* out );
...
protected:
    ...
    #ifdef TIXML_CPP_USE_STL
    static bool	StreamWhiteSpace( std::istream * in, TIXML_CPP_STRING * tag );
    static bool StreamTo( std::istream * in, int character, TIXML_CPP_STRING * tag );
	#endif
	...
	*/
    static const char* ReadName( const char* p, TIXML_CPP_STRING* name, TiXmlEncoding encoding );

	/*	Reads text. Returns a pointer past the given end tag.
		Wickedly complex options, but it keeps the (sensitive) code in one place.
	*/
	static const char* ReadText(	const char* in,				// where to start
                                    TIXML_CPP_STRING* text,			// the string read
...
public:
	...
	*/
    ...
    const TIXML_CPP_STRING& ValueTStr() const { return value; }
...
protected:
    ...
    virtual void StreamIn( std::istream* in, TIXML_CPP_STRING* tag ) = 0;
	#endif
...
public:
    ...
    const TIXML_CPP_STRING& NameTStr() const { return name; }
	...
	*/
    ...
    void Print( FILE* cfile, int depth, TIXML_CPP_STRING* str ) const;
...
protected:
    ...
    #ifdef TIXML_CPP_USE_STL
    virtual void StreamIn( std::istream * in, TIXML_CPP_STRING * tag );
	#endif
	/*	[internal use]
...
public:
    ...
    virtual void Print( FILE* cfile, int depth, TIXML_CPP_STRING* str ) const;
	virtual void Print( FILE* cfile, int depth ) const {
		Print( cfile, depth, 0 );
	}
...
private:
    ...
    TIXML_CPP_STRING version;
    TIXML_CPP_STRING encoding;
    TIXML_CPP_STRING standalone;
};
...
private:
    ...
    TIXML_CPP_STRING type;
    TIXML_CPP_STRING href;
};
...
private:
    ...
    TIXML_CPP_STRING buffer;
    TIXML_CPP_STRING indent;
    TIXML_CPP_STRING lineBreak;
};
